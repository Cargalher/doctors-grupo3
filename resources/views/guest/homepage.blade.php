        ...
        <div class=" test d-flex flex-column flex-wrap justify-content-center align-items-center">
            ...
            <form action="{{ route('toIndex', 0) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <select id="dynamic_select" class="selectpicker mt-4 mb-2" data-show-subtext="false"
                        data-live-search="true" id="specialization" name="specialization" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <div class="text-center">
                                                <img style="object-fit: cover" class="img-fluid rounded-circle dic"
                                                    alt="100%x280" src="{{ asset('img/rec1.jpg') }}">
                                                <div class="card-body">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="text-center">
                                                <img style="object-fit: cover" class="img-fluid rounded-circle dic"
                                                    alt="100%x280" src="{{ asset('img/rec2.png') }}">
                                                <div class="card-body">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="text-center">
                                                <img style="object-fit: cover" class="img-fluid rounded-circle dic"
                                                    alt="100%x280" src="{{ asset('img/rec3.jpeg') }}">
                                                <div class="card-body">
                                ...
                                <div class="carousel-item">
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            <div class="text-center">
                                                <img style="object-fit: cover" class="img-fluid rounded-circle dic"
                                                    alt="100%x280" src="{{ asset('img/rec4.jpeg') }}">
                                                <div class="card-body">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="text-center">
                                                <img style="object-fit: cover" class="img-fluid rounded-circle dic"
                                                    alt="100%x280" src="{{ asset('img/rec5.jpeg') }}">
                                                <div class="card-body">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <div class="text-center">
                                                <img style="object-fit: cover" class="img-fluid rounded-circle dic"
                                                    alt="100%x280" src="{{ asset('img/rec6.jpeg') }}">
                                                <div class="card-body">
